...
- pretrain 10회 후 L1, L2를 동시에 학습한 경우가 가장 좋은 결과를 냈습니다. (gpt-pre:10-lm:50)
- pretrain 5회 보다는 10회 가 더 좋은 성능을 냈습니다.
- 더 많은 데이터를 더 많은 회수를 학습하면 더 좋은 결과를 낼 것으로 예상 됩니다.
- gpt-pre:0-lm:50은 그래프에서는 제외 합니다. (편차가 너무 큼)
...
| gpt-pre:10-lm:0  | 10       | 0   | 9      | 0.163 | 0.839    |
| gpt-pre:10-lm:50 | 10       | 0.5 | 9      | 0.253 | 0.844    |
